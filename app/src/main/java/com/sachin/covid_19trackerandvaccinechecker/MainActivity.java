package com.sachin.covid_19trackerandvaccinechecker;
...
import com.sachin.covid_19trackerandvaccinechecker.Activity.StateWiseDataActivity;
//import com.sachin.covid_19trackerandvaccinechecker.Activity.VaccineCheckerActivity;
import com.sachin.covid_19trackerandvaccinechecker.Activity.VaccineChecker;
import com.sachin.covid_19trackerandvaccinechecker.Activity.WorldDataActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private LinearLayout lin_state_data, lin_world_data,lin_vaccine_checker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lin_vaccine_checker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, VaccineChecker.class));
            }
        });
    }
    ...
    private void Init() {
        ...
        lin_vaccine_checker = findViewById(R.id.covid_vaccine_check);
    }
