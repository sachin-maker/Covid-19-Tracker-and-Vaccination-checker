...
import com.sachin.covid_19trackerandvaccinechecker.ActivityAdapter.CenterRVAdapter
import com.sachin.covid_19trackerandvaccinechecker.Model.CenterRvModal
import com.sachin.covid_19trackerandvaccinechecker.R
import org.json.JSONException
import java.util.*
import kotlin.collections.ArrayList

class VaccineChecker : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_vaccine_checker2)


        //setting up the titlebar text
        supportActionBar!!.title = "Covid-19 Vaccination"
        ...
        searchButton.setOnClickListener {
            ...
            if (pinCode.length != 6) {
                ...
                Toast.makeText(this@VaccineChecker, "Please enter valid pin code", Toast.LENGTH_SHORT).show()
            } else {
    ...
    private fun getAppointments(pinCode: String, date: String) {
        ...
        val queue = Volley.newRequestQueue(this@VaccineChecker)
                ...
                JsonObjectRequest(Request.Method.GET, url, null, { response ->
                    ...
                    try {
                        ...
                        { error ->
                            ...
                            Toast.makeText(this@VaccineChecker, "Fail to get response", Toast.LENGTH_SHORT).show()
                        })
